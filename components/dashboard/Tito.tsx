  ...
  return (
    <svg width={size} height={size*1.3} viewBox="0 0 80 104"
      ...
      <g transform={`translate(0,${bob})`}>
        ...
        {/* BOOTS */}
        <g transform={tLL}>
          <rect x={22} y={90} width={12} height={8}  rx={3.5} fill="#2D4A7A"/>
          <rect x={20} y={95} width={15} height={5}  rx={2.5} fill="#1E2A4A"/>
          {fly && <ellipse cx={28} cy={97} rx={3.5} ry={2} fill="#2D4A7A"/>}
        </g>
        <g transform={tLR}>
          <rect x={46} y={90} width={12} height={8}  rx={3.5} fill="#2D4A7A"/>
          <rect x={45} y={95} width={15} height={5}  rx={2.5} fill="#1E2A4A"/>
          {fly && <ellipse cx={52} cy={97} rx={3.5} ry={2} fill="#2D4A7A"/>}
        </g>
