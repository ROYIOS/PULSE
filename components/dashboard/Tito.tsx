    ...
    <svg width={size} height={size*1.3} viewBox="0 0 80 104"
      ...
      <defs>
        <radialGradient id={`v${id}`} cx="36%" cy="28%">
          ...
          <stop offset="48%"  stopColor="#C9A227" stopOpacity=".62"/>
      ...
      <g transform={`translate(0,${bob})`}>
        ...
        {fly && (<>
          <ellipse cx={30} cy={97+jf*8}  rx={3}   ry={5+jf*9}
            fill="#C9A227" opacity={.85} filter={`url(#gl${id})`}/>
          <ellipse cx={50} cy={97+jf*8}  rx={3}   ry={5+jf*9}
            fill="#C9A227" opacity={.85} filter={`url(#gl${id})`}/>
          <ellipse cx={30} cy={100+jf*8} rx={1.8} ry={3+jf*5}
            fill="#F3E7C1" opacity={.95}/>
          <ellipse cx={50} cy={100+jf*8} rx={1.8} ry={3+jf*5}
            fill="#F3E7C1" opacity={.95}/>
          <ellipse cx={22} cy={72+jf*3}  rx={2} ry={3+jf*2} fill="#C9A227" opacity={.5}/>
          <ellipse cx={58} cy={72+jf*3}  rx={2} ry={3+jf*2} fill="#C9A227" opacity={.5}/>
        </>)}

        {/* TAKEOFF DUST */}
        {phase==="takeoff" && (
          <g opacity={Math.max(0,1-jf*2)}>
            <ellipse cx={30} cy={102} rx={9+jf*14} ry={3} fill="#F3E7C1" opacity={.3}/>
            <ellipse cx={50} cy={102} rx={9+jf*14} ry={3} fill="#F3E7C1" opacity={.3}/>
          </g>
        )}

        {/* BOOTS */}
        <g transform={tLL}>
          <rect x={22} y={90} width={12} height={8}  rx={3.5} fill="#34506B"/>
          <rect x={20} y={95} width={15} height={5}  rx={2.5} fill="#1C2B39"/>
          {fly && <ellipse cx={28} cy={97} rx={3.5} ry={2} fill="#34506B"/>}
        </g>
        <g transform={tLR}>
          <rect x={46} y={90} width={12} height={8}  rx={3.5} fill="#34506B"/>
          <rect x={45} y={95} width={15} height={5}  rx={2.5} fill="#1C2B39"/>
          {fly && <ellipse cx={52} cy={97} rx={3.5} ry={2} fill="#34506B"/>}
        </g>
        ...
        {/* JETPACK */}
        <rect x={27} y={58} width={26} height={16} rx={5} fill="#1C2B39"/>
        <rect x={30} y={61} width={8}  height={4}  rx={2} fill="#C9A227" opacity={fly?.85:.6}/>
        <rect x={42} y={61} width={8}  height={4}  rx={2} fill="#C9A227" opacity={fly?.55:.28}/>
        <rect x={28} y={71} width={7}  height={5}  rx={2.5} fill="#34506B"/>
        <rect x={45} y={71} width={7}  height={5}  rx={2.5} fill="#34506B"/>
        ...
        <g transform={`rotate(${bodyLean} 40 62)`}>
          ...
          <text x={40} y={54} fontSize={4.5} textAnchor="middle"
            fill="#1C2B39" fontWeight={700} opacity={.4}>PULSE</text>
          <circle cx={29} cy={63} r={2.2} fill="#C9A227" opacity={.9}/>
          <circle cx={36} cy={65} r={1.8} fill="#B23A2E" opacity={.75}/>
          <circle cx={44} cy={65} r={1.8} fill="#2F6B4F" opacity={.75}/>
          <circle cx={51} cy={63} r={2.2} fill="#C9A227" opacity={.9}/>
          <ellipse cx={28} cy={45} rx={9} ry={5} fill="white" opacity={.13}/>

          {/* LAPTOP — work mood */}
          {mood==="work" && (<>
            <rect x={26} y={70} width={28} height={4}  rx={1.5} fill="#1C2B39"/>
            <rect x={27} y={54} width={26} height={18} rx={3}   fill="#1C2B39"/>
            <rect x={28} y={55} width={24} height={14} rx={2}   fill="#C9A227" opacity={.85}/>
        ...
        <ellipse cx={40} cy={24} rx={15} ry={17}
          fill={`url(#v${id})`} stroke="#C9A227" strokeWidth={1}/>
        <ellipse cx={34} cy={14} rx={6}  ry={3.5} fill="white" opacity={.2}/>

        {/* EYES */}
        {mood==="curious"||lk ? (<>
          <ellipse cx={33} cy={22} rx={5}   ry={6}   fill="rgba(10,26,40,.65)"/>
          <ellipse cx={33} cy={22} rx={3.5} ry={4.5} fill="#C9A227"/>
          <ellipse cx={33} cy={22} rx={2.2} ry={3}   fill="#F3E7C1"/>
          <circle  cx={34} cy={19} r={1.3}  fill="white"/>
          <ellipse cx={47} cy={21} rx={7}   ry={7.5} fill="rgba(10,26,40,.65)"/>
          <ellipse cx={47} cy={21} rx={5.5} ry={5.5} fill="#C9A227"/>
          <ellipse cx={47} cy={21} rx={3.5} ry={3.5} fill="#F3E7C1"/>
          <circle  cx={48} cy={18} r={1.8}  fill="white"/>
        </>) : mood==="sitting"||(mood as string)==="wave" ? (<>
          <ellipse cx={33} cy={23} rx={5.5} ry={4}   fill="rgba(10,26,40,.65)"/>
          <ellipse cx={33} cy={23} rx={4}   ry={3}   fill="#C9A227"/>
          <ellipse cx={33} cy={23} rx={2.5} ry={2}   fill="#F3E7C1"/>
          <ellipse cx={47} cy={23} rx={5.5} ry={4}   fill="rgba(10,26,40,.65)"/>
          <ellipse cx={47} cy={23} rx={4}   ry={3}   fill="#C9A227"/>
          <ellipse cx={47} cy={23} rx={2.5} ry={2}   fill="#F3E7C1"/>
        </>) : (<>
          <ellipse cx={33} cy={22} rx={5.5} ry={6}   fill="rgba(10,26,40,.65)"/>
          <ellipse cx={33} cy={22} rx={4}   ry={4.5} fill="#C9A227"/>
          <ellipse cx={33} cy={22} rx={2.5} ry={3}   fill="#F3E7C1"/>
          <circle  cx={34} cy={19} r={1.4}  fill="white"/>
          <ellipse cx={47} cy={22} rx={5.5} ry={6}   fill="rgba(10,26,40,.65)"/>
          <ellipse cx={47} cy={22} rx={4}   ry={4.5} fill="#C9A227"/>
          <ellipse cx={47} cy={22} rx={2.5} ry={3}   fill="#F3E7C1"/>
        ...
        {/* ANTENNA */}
        <rect x={38} y={0} width={3} height={10} rx={1.5} fill="#34506B"/>
        <circle cx={39} cy={-1} r={4} fill="#C9A227" opacity={.9}
          style={{animation:"tAnt .8s ease-in-out infinite"} as React.CSSProperties}/>
        <circle cx={39} cy={-1} r={2} fill="#F3E7C1"/>
      </g>
    </svg>
  );
}
